...
* Every function block (FB) must have a header comment block containing: block name, purpose, calling OB, author, and applicable standards
...
* `notes-tr/` = Turkish personal notes (optional, for self-reference)
* Field terms in German where applicable (Freigabe, Störung, Sollwert, etc.)
